...
const Pro21 = () => {
  ...
  const productInfo = {id: 2, product: "Black color sofa", category: "sofa", price: 3199, imageUrl: "sofa6.png" };
    const products = [
    ...
    return (
        <div>
            <div className="header" ><h2>Black color Sofa</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="sofa6.png" alt="nothing" style={{width:"300px"}}></img>
                <div style={{ width: "500px" }}>
                    <h2 >Black color Sofa</h2>
