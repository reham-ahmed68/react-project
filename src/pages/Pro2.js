...
const Pro2=()=>{
  ...
  const productInfo = {id: 2, product: "Hoodie Defacto", category: "Men fashion", price: 2499, imageUrl: "/1 (6).jpg" };
     ...
     const products = [
      ...
      return (
          <div>
              <div className="header" ><h2>Hoodie Defacto</h2></div>
              <div className="d-flex" style={{ marginBottom: "20px" }}>
                  <img src="1 (6).jpg" alt="nothing"></img>
                  <div style={{ width: "500px"  , marginLeft:"20px"}}>
                      <h2 >Hoodie Defacto</h2>
