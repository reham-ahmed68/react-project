...
const Pro13 = () => {
  ...
  const productInfo = {id: 2, product: "SODO headphone", category: "headphone", price: 1299, imageUrl: "1 (8).jpg" };
    const products= [
       ...
       return (
           <div>
               <div className="header" ><h2>SODO headphone</h2></div>
               <div className="d-flex" style={{ marginBottom: "20px" }}>
                   <img src="1 (8).jpg" alt="nothing"></img>
                   <div style={{ width: "500px" , marginLeft:"20px" }}>
                       <h2 >SODO headphone</h2>
