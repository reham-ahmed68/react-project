...
const Pro1 = () => {
  ...
  const productInfo = {id: 2, product: "T-shirt Defacto", category: "Men fashion", price: 2000, imageUrl: "/1 (7).jpg" };
    ...
    return (
        <div>
            <div className="header" ><h2>T-shirt Defacto</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="1 (7).jpg" alt="nothing"></img>
                <div style={{ width: "500px" , marginLeft:"20px" }}>
                    <h2 >T-shirt Defacto</h2>
