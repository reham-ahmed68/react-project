...
const Pro18 = () => {
  ...
  const productInfo = {id: 2, product: "Gray color sofa", category: "sofa", price: 2499, imageUrl: "sofa3.png" };
    const products = [
    ...
    return (
        <div>
            ...
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="sofa3.png" alt="nothing" style={{width:"300px"}}></img>
