...
const Pro11 = () => {
  ...
  const productInfo = {id: 2, product: "Nokia", category: "Phone", price: 2499, imageUrl: "Nokia.png" };
   const products= [
             ...
             return (
                 <div>
                     <div className="header" ><h2>Nokia</h2></div>
                     <div className="d-flex" style={{ marginBottom: "20px" }}>
                         <img src="nokia.png" alt="nothing"></img>
                         <div style={{ width: "500px" }}>
                             <h2 >Nokia</h2>
                             <div style={{ margin: "10px 0"  , marginLeft:"20px"}}><i className="fa-solid fa-star" style={{ color: "rgb(255, 208, 0)" }}></i><i className="fa-solid fa-star" style={{ color: "rgb(255, 208, 0)" }}></i><i className="fa-solid fa-star" style={{ color: "rgb(255, 208, 0)" }}></i> 3 ratings</div>
                             <h3>$2499 </h3>
