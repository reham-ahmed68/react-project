...
const Pro3 = () => {
    ...
    const productInfo = {id: 2, product: "Woven Dress Defacto", category: "Women fashion", price: 1189, imageUrl: "/1 (1)2.jpg" };
   const products = [ 
    ...
    return (
        <div>
            <div className="header" ><h2>Woven Dress Defacto</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="1 (1)2.jpg" alt="nothing"></img>
                <div style={{ width: "500px"  , marginLeft:"20px"}}>
                    <h2 >Woven Dress Defacto</h2>
