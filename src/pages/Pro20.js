...
const Pro20 = () => {
  ...
  const productInfo = {id: 2, product: "olive color sofa", category: "sofa", price: 2499, imageUrl: "sofa5.png" };
    const products = [
    ...
    return (
        <div>
            <div className="header" ><h2>olive color sofa</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="sofa5.png" alt="nothing" style={{width:"300px"}}></img>
                <div style={{ width: "500px" }}>
                    <h2 >olive color sofa</h2>
