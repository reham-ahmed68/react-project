...
const Pro5 = () => {
  ...
  const productInfo = {id: 2, product: "Skinny Trousers", category: "Women fashion", price: 1299, imageUrl: "/1.jpg" };
   const products = [ 
    ...
    return (
        <div>
            <div className="header" ><h2>Skinny Trousers</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="1.jpg" alt="nothing"></img>
                <div style={{ width: "500px" , marginLeft:"20px" }}>
                    <h2 >Skinny Trousers</h2>
