...
const Pro12 = () => {
  ...
  const productInfo = {id: 2, product: "Realme", category: "Phone", price: 2000, imageUrl: "1 (13).jpg" };
    const products= [
          ...
          return (
              <div>
                  <div className="header" ><h2>Realme</h2></div>
                  <div className="d-flex" style={{ marginBottom: "20px" }}>
                      <img src="1 (13).jpg" alt="nothing"></img>
