...
const Pro15 = () => {
  ...
  const productInfo = {id: 2, product: "P9 gray headphone", category: "headphone", price: 699, imageUrl: "1 (14).jpg" };
    const products= [
    ...
    return (
        <div>
            <div className="header" ><h2>P9 gray headphone</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="1 (14).jpg" alt="nothing"></img>
