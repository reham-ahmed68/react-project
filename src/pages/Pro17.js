...
const Pro17 = () => {
  ...
  const productInfo = {id: 2, product: "Bage color sofa", category: "sofa", price: 2499, imageUrl: "sofa2.png" };
    const products = [
    ...
    return (
        <div>
            <div className="header" ><h2>Bage color sofa</h2></div>
            <div className="d-flex" style={{ marginBottom: "20px" }}>
                <img src="sofa2.png" alt="nothing" style={{width:"300px"}}></img>
                <div style={{ width: "500px" }}>
                    <h2 >Bage color sofa</h2>
